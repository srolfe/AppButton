...
@interface ABAboutKyleTableCell : PSTableCell{ //<PreferencesTableCustomView>
	UILabel *_label;
	UILabel *_jobText;
...
@implementation ABAboutKyleTableCell
	...
	-(id)initWithStyle:(int)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3 { //init method
		...
		if (self) {
			NSString *personPath=[[NSBundle bundleForClass:[self class]] pathForResource:@"kyle" ofType:@"png"];
			...
			NSMutableAttributedString *attributedString=[[NSMutableAttributedString alloc] initWithString:@"Kyle Revony @Krevony"];
			[attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"HelveticaNeue" size:24] range:NSMakeRange(0, 11)];
			[attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:24] range:NSMakeRange(11, 9)];
